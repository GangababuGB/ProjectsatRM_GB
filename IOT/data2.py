...
s5_I=s6_I=s7_I=s8_I = 0
cnames = ['TS', 'xs1', 'xs2', 'xs3', 'xs4', 'xs5', 'xs6', 'xs7', 'xs8']
dt = datetime.now()
...
while True:
        ...
        s5 = random.uniform(110.55, 111.55)
        s6 = random.uniform(330.55, 350.55)
        s7 = random.uniform(600.55, 620.55)
        s8 = random.uniform(90.55, 93.55)
        ...
        print(TS, xs1, xs2, xs3, xs4, xs5, xs6, xs7, xs8)
